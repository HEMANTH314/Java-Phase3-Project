...
const routes: Routes =
         ...
         {path:'ipos',component:IposComponent},
          ...
          {path: 'stock-exchanges', component: StockExchangesComponent},
           ...
           {path:'edit-ipo/:Id',component:EditIPOComponent},
           {path:'edit-stock-exchange/:Id',component:EditStockExchangeComponent},
           {path:'editsector/:Id',component:EditsectorComponent},
